...
//     {
//       name: "YouTube",
//       href: "https://youtube.com/@chandraobula",
//       icon: (
//         <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
...
//         <div
//           className="text-[25vw] font-black leading-none text-white opacity-[0.08] text-center"
...
//         {/* Contact Information */}
//         <div className="grid md:grid-cols-3 gap-12 mb-20 max-w-4xl">
//           {/* Email */}
//           <motion.div
...
//                 <span className="text-white/40 text-sm">Made in</span>
